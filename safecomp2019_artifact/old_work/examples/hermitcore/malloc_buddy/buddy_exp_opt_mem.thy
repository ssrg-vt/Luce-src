...
lemma rewrite_exp:
  assumes \<open>master blocks (a, 1) 2\<close>
      and \<open>master blocks (rsp\<^sub>0, 8) 3\<close>
  ...
  subgoal premises prems for \<sigma>
    ...
    apply (symbolic_execution del: imp_disjL) (* jbe .label_17 *)
    ...
    apply symbolic_execution (* mov *)
    apply symbolic_execution (* nop *)
    apply symbolic_execution (* add *)
    apply symbolic_execution (* mov *)
    apply symbolic_execution (* shl *)
  ...
  subgoal premises prems for \<sigma>
    ...
    (* Apply VCG/symb. execution *)
    apply symbolic_execution (* cmp *)
    apply symbolic_execution (* jb .label_18 *)
     apply symbolic_execution (* add *)
     apply symbolic_execution (* mov *)
     apply symbolic_execution (* shl *)
     apply symbolic_execution (* movsxd *)
    ...
    apply symbolic_execution (* cmp *)
    apply symbolic_execution (* mov *)
    apply symbolic_execution (* cmovae *)
     apply symbolic_execution (* mov *)
     apply symbolic_execution (* ret*)
