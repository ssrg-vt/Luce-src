...
schematic_goal "bdrv_pread_em":
  assumes
    ...
    and [blocks]: \<open>{{Q_rep_movs_ESRDI_DSRSI_addr_0x184b8_7}} \<box>rep_movs_ESRDI_DSRSI_acode {{P_0x184bb_15;M_0x184b8}}\<close> (* post originally _8, generation error *)
